...
st.write("### Ada pesan khusus yang sengaja aku buatkan lewat kode Python ini...")
...
with col1:
    st.image("https://images.unsplash.com/photo-1518199266791-5375a83190b7?w=500", caption="Senyum favoritku 🥰")
with col2:
